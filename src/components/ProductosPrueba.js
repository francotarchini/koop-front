...
/* Api Real para concretar el CRUD  y persistir en MongoDDB Atlas */
...
function Productos() {
  ...
  const [productoSeleccionadoPost,setProductoSeleccionadoPost]=useState({
    producto: "",
    descripcion: "",
    precio: "",
    unidades: "",
  ...
  /*Metodo para capturar los inputs o textfield del Modal de Insertar Producto*/
  const handleChangeInsert=e=>{
    const {name, value}=e.target;
    setProductoSeleccionadoPost(prevState=>({
      ...prevState,
      [name]: value
    }));
    console.log(productoSeleccionadoPost);
  }
  ...
  /**--------------------------------------- */
    ...
    const insertarProducto=(
      <div className={styles.modal}>
        ...
        <TextField className={styles.imputMaterial} label="Producto" name="producto" onChange={handleChangeInsert}/>
        <br/>
        <TextField className={styles.imputMaterial} label="Descripcion" name="descripcion" onChange={handleChangeInsert}/>
        <br/>
        <TextField className={styles.imputMaterial} label="Precio" name="precio" onChange={handleChangeInsert}/>
        <br/>
        <TextField className={styles.imputMaterial} label="Unidades" name="unidades" onChange={handleChangeInsert}/>
        <br/>
        <div align="right">
